...
BLOG_TITLE = "Localiza"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://map0logo.github.io/localiza/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://map0logo.github.io/localiza/"
BLOG_EMAIL = "mapologo@tutta.io"
BLOG_DESCRIPTION = "Open source library for location models and science"  # (translatable)
